...
process.env.QUEUE_ENV = common.setQueueName(app_cnfg.ENV, app_cnfg.APP_AGENCY, app_cnfg.APP_NAME);
...
REST.prototype.configureExpress = function () {
    ...
    console.log('INFO: [QUEUE]', process.env.QUEUE_ENV, redis_cnfg.REDIS_CNFG.redis, i, 'CONSUMERS.');
...
REST.prototype.startServer = function () {
    ...
    const server = app.listen(app_cnfg.APP_PORT, function () {
        ...
        console.log('INFO: [APWKR]', process.env.NODE_ENV, app_cnfg.APP_AGENCY, app_cnfg.APP_NAME,
                    'PORT:', app_cnfg.APP_PORT, 'T/O:', server.timeout);
    });
}
